...
in
{
  ...
  workspace = {
    dlv-list = rustPackages.unknown.dlv-list."0.6.0";
  };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".const-random."0.1.18" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "dlv-list/const-random" then "const_random_macro" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".const-random-macro."0.1.16" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".const-random-macro."0.1.16" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "dlv-list/const-random" then "getrandom" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".getrandom."0.2.16" { inherit profileName; }).out;
      ${ if rootFeatures' ? "dlv-list/const-random" then "once_cell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.3" { inherit profileName; }).out;
      ${ if rootFeatures' ? "dlv-list/const-random" then "tiny_keccak" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tiny-keccak."2.0.2" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".crunchy."0.2.4" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "default")
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "limit_128")
    ];
  });
  
  "unknown".dlv-list."0.6.0" = overridableMkRustCrate (profileName: rec {
    name = "dlv-list";
    version = "0.6.0";
    registry = "unknown";
    src = fetchCrateLocal workspaceSrc;
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "const-random")
      (lib.optional (rootFeatures' ? "dlv-list/default") "default")
      (lib.optional (rootFeatures' ? "dlv-list/serde") "serde")
      (lib.optional (rootFeatures' ? "dlv-list/default" || rootFeatures' ? "dlv-list/std") "std")
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".getrandom."0.2.16" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "dlv-list/const-random" then "cfg_if" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.4" { inherit profileName; }).out;
      ${ if rootFeatures' ? "dlv-list/const-random" && hostPlatform.isUnix then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.177" { inherit profileName; }).out;
      ${ if rootFeatures' ? "dlv-list/const-random" && hostPlatform.parsed.kernel.name == "wasi" then "wasi" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasi."0.11.1+wasi-snapshot-preview1" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.3" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "alloc")
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "race")
    ];
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tiny-keccak."2.0.2" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "default")
      (lib.optional (rootFeatures' ? "dlv-list/const-random") "shake")
    ];
    dependencies = {
      ${ if rootFeatures' ? "dlv-list/const-random" then "crunchy" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".crunchy."0.2.4" { inherit profileName; }).out;
    };
  });
